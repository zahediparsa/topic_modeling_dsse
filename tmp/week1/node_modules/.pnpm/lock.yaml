  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.14.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.14.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.14.tgz':
    resolution: {integrity: sha512-+hHWSaVOLY3haJu6zbyxRGUrsyKKmuITnAe0ET5Q87XdTzmN6KBsOBrbGbpBZbsX3hsIYu3+1Dfust9EbPUQzw==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.14.tgz}
    version: 2.8.14
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
